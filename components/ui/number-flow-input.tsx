...
export function NumberFlowInput({ 
  ...
  className
	...
	return (
		<div className={clsx(
      "group flex items-stretch rounded-md text-xl font-semibold ring ring-zinc-200 transition-[box-shadow] focus-within:ring-2 focus-within:ring-blue-500 dark:ring-zinc-800",
      className
    )}>
			<button
				aria-hidden="true"
